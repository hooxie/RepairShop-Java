    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(request->request
                        .requestMatchers(HttpMethod.POST, "/webapi/car").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/webapi/repairshop").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/webapi/repairshops/**").authenticated()
